...
export interface CreationMeta {
  ...
  icon: string;
  /** false = placeholder route (P1 canvas creators) */
  ready: boolean;
}
...
export const CREATIONS: CreationMeta[] = [
  ...
  { type: "doodle", label: "Doodle", microcopy: "Draw the thing you can't say in words.", href: "/create/doodle", icon: "Pencil", ready: false },
  { type: "bouquet", label: "Bouquet", microcopy: "Pick flowers that feel like them.", href: "/create/bouquet", icon: "Flower2", ready: false },
  { type: "collage", label: "Collage", microcopy: "Put your favorite little moments together.", href: "/create/collage", icon: "LayoutGrid", ready: false }
];
